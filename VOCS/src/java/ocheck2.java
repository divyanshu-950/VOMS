 ...
 * @author user
 */
public class ocheck2 extends HttpServlet {
...
"          <h2>\"Don't be a fool, pack light and keep it cool!\"</h2>\n" +
"        </div>\n" +
"      </div>\n" +
"\n" +
"    </div>\n" +
...
"    <!-- ======= About Section ======= -->\n" +
"      <div class=\"col-xl-6 col-lg-8\">\n" +
"             <h1 id=\"voh\">Welcome to Overloading Check Portal<span>.</span></h1>\n" +
"             </div>\n" +
"             <div class=\"inner\">\n" +
...
"              </div>\n" );
               try {
                ...
                Statement stmnt = con.createStatement();
                 ResultSet rs,rs2;
                rs = stmnt.executeQuery("SELECT `vehicle`,`weight` FROM `weightlimit` order BY sno DESC");
                while(rs.next()){
                vehicle = rs.getString(1);
                totalweight = Integer.parseInt(rs.getString(2));
                break;
             }
                
                 rs2 = stmnt.executeQuery("SELECT `GVW` FROM `vehicle_data` WHERE `vehicle` = '"+vehicle+"'");
                while(rs2.next()){
               gvw = Integer.parseInt(rs2.getString(1));
             }
                 if(totalweight > gvw){
                    msg = " Overoaded By : " +(totalweight - gvw) +"KG";
...
out.println("<form action=\"manua2\" style=\"width:85%;\">\n" +
"                <h3 style=\"color: #70873c;\"><u>Vehicle Information  </u></h3>\n" +
"               \n" +
"                <div class=\"form-wrapper\">\n" +
"                  <h4 style=\"color: #007f04; margin-bottom: 20px;\"> Vehicle Model :<span style=\"color: black;\"> "+ vehicle + "</span> </h4>");
            out.println("</div>\n" +
"                <div class=\"form-wrapper\">\n" +
"                   <h4 style=\"color: #007f04; margin-bottom: 20px;\"> Vehicle Total Weight :<span style=\"color: black;\">"+totalweight+"</span> </h4>\n" +
"                    </div>\n" +
"                <div class=\"form-wrapper\">\n" +
"                  <h4 style=\"color: #007f04; margin-bottom: 20px;\">Vehicle GVW :<span style=\"color: black;\">"+gvw+"</span> </h4>\n" +
"                    </div>\n" +
"                <div class=\"form-wrapper\">\n" +
"                  <h4 style=\"color: #007f04; margin-bottom: 20px;\">Your Vehicle is :<span style=\"color: black; margin-bottom: 20px;\">"+msg+"</span></h4>\n" +
"                    </div>\n" );
...
"              <li><i class=\"bx bx-chevron-right\"></i> <a href=\"addworker.html\">Add Worker</a></li>\n" +
"            </ul>\n" +
"          </div>\n" +
"\n" +
