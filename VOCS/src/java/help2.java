 ...
 * @author user
 */
public class help2 extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
       ...
       HttpSession session = request.getSession(false);
           ...
           if(name.equals("") || email.equals("") || vehicle.equals("") || gvw.equals("")){
        ...
        try {
                ...
                stmnt.executeUpdate("INSERT INTO `help_us` (`name`, `email`, `vehicle_name`, `gvw`) VALUES ('"+name+"', '"+email+"', '"+vehicle+"', '"+gvw+"')");
                 out.println("<html><body><script>window.confirm('Thank You for Enlighting Us');</script></body></html>");
                request.getRequestDispatcher("help").include(request, response);
                con.close();
            }catch(Exception e){
           e.printStackTrace();
