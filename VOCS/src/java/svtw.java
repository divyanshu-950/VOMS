 ...
 * @author user
 */
public class svtw extends HttpServlet {
...
"        <ul>\n" +
"          <li><a class=\"nav-link scrollto active\" href=\"worker_index.html\">Home</a></li>\n" +
"          <li><a class=\"nav-link scrollto\" href=\"#about\">About</a></li>\n" +
"          <li class=\"dropdown\"><a href=\"#\"><span>Services</span> <i class=\"bi bi-chevron-down\"></i></a>\n" +
"            <ul>\n" +
"              <li><a href=\"svtw\">Provide Vehicle Info.</a></li>\n"  +
"            </ul>\n" +
"          </li>\n" +
...
"          <h2>\"Overload no more, keep safety at the core!\"</h2>\n" +
"        </div>\n" +
"      </div>\n" +
"\n" +
"    </div>\n" +
...
"    <!-- ======= About Section ======= -->\n" +
"      <div class=\"col-xl-6 col-lg-8\">\n" +
"             <h1 id=\"voh\">Provide Vehicle Information Section <span>.</span></h1>\n" +
"             </div>\n" +
"             <div class=\"inner\">\n" +
...
"              </div>\n" +
"              <form action=\"svtw2\">\n" +
"                <h3 style=\"color: #70873c;\">Provide Vehicle Information Here</h3>\n" +
"               \n" +
"                <div class=\"form-wrapper\">\n" +
"                  <label for=\"v0\">Choose Vehicle: </label>");
            out.println("<select name='vehicle_name' id='v0' style='margin-bottom:70px;'>");
             try {
           ...
           out.println("</div>\n" +
"                <div class=\"form-wrapper\">\n" +
"                  <label for=\"v\">Vehicle Total Weight : </label>\n" +
"                  <input type=\"number\" placeholder=\"KG\" class=\"form-control\" value=\"0\" name=\"totalweight\">\n" +
"                </div>\n" +
"                <button>ADD\n" +
...
"              <h4><a href=\"svtw\">Provide Vehicle Total Weight</a></h4>\n" +
"              <p> Provides Incoming Vehicle Total Weight.</p>\n" +
"            </div>\n" +
"          </div>\n" +
"\n" +
"        </div>\n" +
