...
"          <h2>\"Overloading can lead to catastrophic unfolding.\"</h2>\n" +
"        </div>\n" +
"      </div>\n" +
"\n" +
"    </div>\n" +
...
"      <div class=\"col-xl-6 col-lg-8\">\n" +
"             <h1 id=\"voh\">Welcome to View Vehicle GVW Portal<span>.</span></h1>\n" +
"             </div>\n" +
"             <div class=\"inner\">\n" +
"                <div class=\"form-wrapper\" style=\"overflow-y:scroll; height:500px;overflow-x: hidden;\">\n" );
            out.println("<table>"+"<tr> <th> Vehicle Model</th> <th> Gross Vehicle Weight </th> </tr>");
             try {
                Class.forName("com.mysql.cj.jdbc.Driver");
                Connection con = DriverManager.getConnection("jdbc:mysql://localhost:3306/div1","root","");
                Statement stmnt = con.createStatement();
                 ResultSet rs;
                rs = stmnt.executeQuery("SELECT `vehicle`,`GVW` FROM `vehicle_data`");
                while(rs.next()){
...
"              <li><i class=\"bx bx-chevron-right\"></i> <a href=\"#\">Add Worker</a></li>\n" +
"            </ul>\n" +
"          </div>\n" +
"\n" +
